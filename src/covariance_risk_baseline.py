...
PROJECT = {"analysis_type": "covariance", "category": "Stochastic Models & Market Risk", "columns": ["asset", "weight", "ret_1", "ret_2", "ret_3", "ret_4", "ret_5", "ret_6", "ret_7", "ret_8"], "methods": ["표본 공분산 행렬과 가중치 벡터로 포트폴리오 분산을 산출한다.", "각 자산의 marginal contribution과 component contribution을 구분한다.", "자산명과 수익률은 리스크 분해 흐름을 설명하는 합성 패널이다."], "module_name": "covariance_risk_baseline", "objective": "자산별 수익률 공분산과 포트폴리오 가중치로 리스크 기여도를 분해한다.", "question": "포트폴리오 변동성은 어떤 자산의 개별 변동성과 상관구조에서 주로 발생하는가?", "rows": [["EQUITY_GROWTH", 0.42, 0.012, -0.006, 0.018, -0.014, 0.009, 0.004, -0.011, 0.015], ["QUALITY_EQUITY", 0.28, 0.008, -0.003, 0.011, -0.008, 0.006, 0.005, -0.006, 0.01], ["TREASURY_BOND", 0.2, -0.002, 0.004, -0.001, 0.006, 0.003, -0.002, 0.005, -0.001], ["COMMODITY_HEDGE", 0.1, 0.005, 0.009, -0.007, 0.011, -0.006, 0.008, 0.002, -0.004]], "sample_name": "asset_return_panel.csv", "title_en": "Covariance Risk Decomposition", "title_ko": "공분산 리스크 분해"}
